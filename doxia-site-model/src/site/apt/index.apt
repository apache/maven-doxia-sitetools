...
Doxia Sitetool Site Model
 ...
 This is strictly the model for Doxia Sitetool Site Model, used in maven-site-plugin as <<<site.xml>>> to inject
 parameters into site template: see {{{../doxia-site-renderer/}Doxia Site Renderer}} for more details on site rendering.
...
* Inheritance
 ...
 Site model can be merged from a parent <<<site.xml>>> into a child <<<site.xml>>> using
 <<<SiteModelInheritanceAssembler>>> ({{{./apidocs/org/apache/maven/doxia/site/inheritance/SiteModelInheritanceAssembler.html}javadoc}})
